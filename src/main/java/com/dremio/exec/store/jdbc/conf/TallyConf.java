...
@SourceType(value = "TallyARP", label = "Tally",uiConfig = "tally-layout.json")
public class TallyConf extends AbstractArpConf<TallyConf> {
  private static final String ARP_FILENAME = "arp/implementation/tally-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.tally.TallyDriver";
